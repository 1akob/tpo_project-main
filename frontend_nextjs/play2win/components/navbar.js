...
export default function navbar() {
  ...
  return (
    ...
    {isLogged &&<a href="/private_index" class="flex">
    ...
    <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-3">
      ...
      {isLogged ==1 &&
        <li>
          <a href="private_index" class="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Home</a>
        </li>}
        {isLogged ==1 &&
        <li >
